...
const DEPARTMENTS = [
  ...
  { name: 'Directorship Team', description: 'The New York City Roleplay Directorship Team is responsible for the general management of the Discord server and in-game server. This team manages and oversees the work of the department heads, but also general staff members alongside that.', lead: 'Coach' },
  { name: 'Foundership Team', description: 'The New York City Roleplay Foundership Team handles every aspect of the server, and manages the Directorship Team. This team consists of the two owners of New York City Roleplay.', lead: 'Harley, Jay & Chicken' },
